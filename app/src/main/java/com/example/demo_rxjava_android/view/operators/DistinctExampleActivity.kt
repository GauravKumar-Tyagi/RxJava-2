...
class DistinctExampleActivity  : AppCompatActivity() {
    var TAG : String = DistinctExampleActivity::class.java.simpleName
    var LINE_SEPARATOR = "\n"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textFunctions?.text = "Observable.just with distinct &   Observer with : "+"onSubscribe , "+"onNext , "+"onError  ,  "+" onComplete "
    }
