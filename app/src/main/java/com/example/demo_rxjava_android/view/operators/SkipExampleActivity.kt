...
class SkipExampleActivity : AppCompatActivity() {
    var TAG : String = SkipExampleActivity::class.java.simpleName
    var LINE_SEPARATOR = "\n"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textFunctions?.text = "Observable.just with skip &   Observer with : "+"onSubscribe , "+"onNext , "+"onError  ,  "+" onComplete "
    }
